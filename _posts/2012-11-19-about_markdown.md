...
###好了，一起来玩吧~
    ...
    Markdown是你使用jekyll快速开发个人博客的得力助手，还在头疼那些烦人的缩进和源代码插入的效果问题吗？是时候看看这篇博客了哦，有了她你可以快速的完成你的个人博客，像写代码一样写博客吧。
...
Markdown 使用星号和底线作为标记强调字词的符号，被或 包围的字词会被转成用  标签包围用两个或 _ 包起来的话，则会被转成 ，例如：
...
但是如果你的  和  两边都有空白的话，它们就只会被当成普通的符号。
